...
public class ShopUi : MonoBehaviour {
	...
	public TextMeshProUGUI cashText; // Ändere dies
	public TextMeshProUGUI buyErrorText; // Ändere dies
	public TextMeshProUGUI pageText; // Ändere dies
	...
	public void SwitchMode(int m){
		...
		UpdateUi();
		if(pageText){
			pageText.GetComponent<TextMeshProUGUI>().text = "1";
		}
		if(cashText){
	...
	public void UpdateUi(){
		...
		if(mode == 0){
			...
			for (int a = 0; a < shopUi.Length; a++) {
				int index = a + cPage;
				if (index < shopSlot.Length && index >= 0 && shopSlot[index].itemId > 0) {
